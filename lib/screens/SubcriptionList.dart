...
class _SubcriptionListState extends State<SubcriptionList> {
  ...
  body() {
    return isLoading
        ...
        : subscriptionListClass == null || subscriptionListClass.data.data.isEmpty
            ? PlaceHolderScreen(
            ...
            : ListView.builder(
                itemCount: subscriptionListClass.data.data.length,
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                subscriptionListClass.data.data[index].packagedata.name,
          ...
          Row(
            children: [
              ...
              Text(
                subscriptionListClass.data.data[index].date,
              ...
              Text(
                subscriptionListClass.data.data[index].time,
                style: TextStyle(color: NAVY_BLUE, fontSize: 10),
              ),
            ],
          ),
          Text(
            subscriptionListClass.data.data[index].packagedata.description,
            style: TextStyle(color: NAVY_BLUE, fontSize: 10),
          ),
          SizedBox(
            height: 16,
          ...
          Row(
            children: [
              Text(
                "$CURRENCY${subscriptionListClass.data.data[index].amount}/month",
